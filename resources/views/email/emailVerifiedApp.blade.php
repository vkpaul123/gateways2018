                    ...
                    <div class="jumbotron">
                        <center>
                            <h3 class="text-success">
                                ...
                                <hr>
                                <i class="fa fa-check"></i> &nbsp; Account Activated.
                            </h3>
                            <h2>
                                Log in to your account. <br>
                                <small>
                                    Account Associated to <strong class="text-info">{{ $email }}</strong> has been verified. You can now log in to your account in the App.
                                </small>
                            </h2>
                        </center>
                    </div>
